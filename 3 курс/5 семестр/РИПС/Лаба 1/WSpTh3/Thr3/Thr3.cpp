...
LONG WndProc_OnDestroy(HWND hWnd)
{
	...
	case WAIT_ABANDONED_0 :	
		...
		break;
	case WAIT_FAILED:
		wsprintf(szRetRes, TEXT("daniil=%d daniil=%d"), WAIT_ABANDONED_0, dwRet);         // добавил
		MessageBox(NULL, szRetRes, "Nikonchik", MB_OK | MB_ICONEXCLAMATION);              // добавил
		GetLastError;                                                                     // добавил
		break;
	case WAIT_OBJECT_0:	
