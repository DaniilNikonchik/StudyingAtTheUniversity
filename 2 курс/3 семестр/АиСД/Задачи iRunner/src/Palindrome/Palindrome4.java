...
public class Palindrome4 {
    public static void main(String[] args) throws Exception {
        ...
        String stroka = String.valueOf(isPalindrome(s));

        //fw.write(String.valueOf(matrix[n][n]));
        fw.write(String.valueOf(len(stroka)));
        fw.write('\n' + stroka);
        fw.close();
        bf.close();
    }
    ...
    public static String isPalindrome(String str) {
        ...
        for (int i = str.length() - 1; i > 0; i--)
            exampleBuilder.append(str.charAt(i));
        String finalString = exampleBuilder.toString() + str;
        return finalString;
    }
